...
class ChatbotEngine:
    ...
    def _looks_like_job_title(text: str) -> bool:
        ...
        negatives = [
            "don't know", "not sure", "no", "none", "nothing",
            "hmm", "hmmm", "ok", "okay", "hi", "hello", "hey", "wtf",
        ]
